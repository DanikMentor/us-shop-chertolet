...
def cr_d():
    ...
    # Insert sample products into the database if not already present
    cursor.executemany("""
    INSERT OR IGNORE INTO products  (Pr_name, Price, Category, Brand, Date, Discount)
    VALUES (?, ?, ?, ?, ?, ?)
    """, sample_products)
